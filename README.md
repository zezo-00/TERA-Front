...
* **[React](https://reactjs.org/):** Core da aplicação para construção de componentes modulares.
* **[Vite](https://vitejs.dev/):** Ferramenta de build de próxima geração para um desenvolvimento rápido e otimizado.
* **[React Router Dom](https://reactrouter.com/):** Gerenciamento inteligente de rotas e navegação.
