      ...
      <section className="linkedin-card-section">
        <div className="linkedin-card">
          ...
          <p className="card-description">
            Junte-se às nossas análises de mercado, dicas de gestão estratégica e conteúdos exclusivos sobre alta performance corporativa.
          </p>

          {/* COLAR O SEU LINK DO LINKEDIN NO HREF ABAIXO */}
          <a href="https://www.linkedin.com/company/tera-consultoria-e-gest%C3%A3o/" target="_blank" rel="noopener noreferrer" className="btn-linkedin">
            <Linkedin size={20} />
